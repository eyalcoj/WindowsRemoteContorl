...
class ServerUserGui(QMainWindow):
    ...
    def __init__(self, name, user_data_saver, users_data_saver,
        ...
        self.want_screen_share_indicator.setFixedSize(Constance.INDICATOR_WIDTH, Constance.INDICATOR_HEIGHT)
        ...
        self.want_keyboard_indicator.setFixedSize(Constance.INDICATOR_WIDTH, Constance.INDICATOR_HEIGHT)
